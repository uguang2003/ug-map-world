...
.ug-list-toggle-btn {
  background: rgba(26, 137, 23, 0.18);
  border: none;
  outline: none;
  border-radius: 50%;
  width: 38px;
  ...
  cursor: pointer;
  transition: background 0.2s, box-shadow 0.2s, transform 0.25s cubic-bezier(0.4, 0, 0.2, 1);
